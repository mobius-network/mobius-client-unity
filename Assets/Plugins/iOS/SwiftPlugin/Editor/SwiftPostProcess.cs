...
public static class SwiftPostProcess {
	...
	public static void OnPostProcessBuild(BuildTarget buildTarget, string buildPath)
	{
		if (buildTarget == BuildTarget.iOS)
		{
			...
			proj.SetBuildProperty(targetGuid, "SWIFT_OBJC_BRIDGING_HEADER", "Libraries/Plugins/iOS/SwiftPlugin/Source/Mobius Uinty iOS Plugin-Bridging-Header.h");
			proj.SetBuildProperty(targetGuid, "SWIFT_OBJC_INTERFACE_HEADER_NAME", "Mobius_Uinty_iOS_Plugin-Swift.h");
